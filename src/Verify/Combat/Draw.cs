...
namespace CompanionAIVerify.Combat
{
    internal class Draw
    {
        ...
        internal void Run()
        {
            ...
            if (_i.SwitchOperation.Switched)
            {
                return;
            }
            ...
            if (_i.ReachValidator.TargetInReach())
            {
                _i.FPVOperation.Run();
                _i.ReleaseOperation.Run();
                _li.Logger.LogTargetOutofRange(_i);
                return;
            }
            ...
            {
                _i.ReleaseOperation.Run();
                _li.Logger.LogRangedProhibited(_i);
                return;
            }
            ...
            {
                _i.ReleaseOperation.Run();
                _li.Logger.LogShootableNotFound(_i);
                return;
            }
            ...
            {
                _i.ReleaseOperation.Run();
                _li.Logger.LogFriendlyInLineOfFire(_i);
                return;
            }
