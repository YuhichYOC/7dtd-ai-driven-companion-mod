...
namespace CompanionAIVerify.Combat.Validate
{
    internal class ADSActionValidator
    {
        ...
        internal ADSActionValidator(InfoHolder i, LogInfoHolder li)
        {
            _i = i;
            _li = li;
        }
        ...
        internal bool CanUseAds()
        {
            ...
            return _i.CanAds = hi != null && hi.Actions != null &&
                hi.Actions.Length >= 2 && hi.Actions[1] != null &&
                hid != null && hid.actionData != null &&
